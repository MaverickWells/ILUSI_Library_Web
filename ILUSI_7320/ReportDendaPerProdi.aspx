<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportDendaPerProdi.aspx.cs" Inherits="ILUSI_7320.ReportDendaPerProdi" %>
...
<body style="background-image:url('Kapus.jpg'); width:auto">
    ...
    <center>
            ...
            <asp:Label runat="server" Text="Laporan Denda Per Prodi Pada Semester Tertentu" ForeColor="White"></asp:Label>
        </center>
        <br />
        <div>    
            <center>
