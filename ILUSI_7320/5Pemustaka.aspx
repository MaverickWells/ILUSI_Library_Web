<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="5Pemustaka.aspx.cs" Inherits="ILUSI_7320._Pemustaka" %>
    ...
    <body style="background-image:url('Kaprodi.jpg'); background-position:right; width:auto">
        <form id="form1" runat="server" >
            <center>            
                ...
                <asp:Label runat="server" Text="Laporan 5 Mahasiswa dan Dosen Paling Aktif" ForeColor="White"></asp:Label>
            </center>
            ...
            <center>
                <label runat="server" style="color:White">Dosen</label>
                ...
                <label runat="server" style="color:White">Mahasiswa</label>
