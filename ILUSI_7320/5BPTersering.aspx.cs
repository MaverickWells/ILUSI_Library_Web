...
using ILUSI_7320.DataSet5BPTerseringTableAdapters;
using CrystalDecisions.CrystalReports.Engine;
using System.Data;

namespace ILUSI_7320
{
    public partial class _BPTersering : System.Web.UI.Page
    {
        private TBL_Detil_TransaksiTableAdapter TB = new TBL_Detil_TransaksiTableAdapter();
        ...
        protected void btnTampil_Click(object sender, EventArgs e)
        {
            ...
            GridView1.DataSource = TB.GetData5BPTersering(user.KodeProdi, tglStart, tglStop);
            GridView1.DataBind();
        }
        ...
        protected void Cetak_Click(object sender, EventArgs e)
        {
            ...
            DT = TB.GetData5BPTersering(user.KodeProdi, tglStart, tglStop);

            RD.Load(Server.MapPath("~/Report5BP.rpt"));
            RD.SetDataSource(DT);
            ...
            RD.ExportToHttpResponse(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, 
                Response, true, "Laporan 5 Bahan Pustaka Paling Sering Dipinjam");
        }
    }
}
