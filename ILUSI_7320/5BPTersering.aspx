<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="5BPTersering.aspx.cs" Inherits="ILUSI_7320._BPTersering" %>
    ...
    <body style="background-image:url('Kaprodi.jpg'); background-position:right; width:auto">
        <form id="form1" runat="server">
            <center>            
                ...
                <asp:Label runat="server" Text="Laporan 5 Bahan Pustaka Paling Sering Dipinjam" ForeColor="White"></asp:Label>
            </center>
