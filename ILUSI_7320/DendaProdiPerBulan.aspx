<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DendaProdiPerBulan.aspx.cs" Inherits="ILUSI_7320.DendaProdiPerBulan" %>
    ...
    <body style="background-image:url('Kapus.jpg'); width:auto">
        <form id="form1" runat="server">
            <center>            
                ...
                <asp:Label runat="server" Text="Laporan Denda Per Bulan Pada Semester Tertentu" ForeColor="White"></asp:Label>
            </center>
