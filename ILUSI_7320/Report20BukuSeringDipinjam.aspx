<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report20BukuSeringDipinjam.aspx.cs" Inherits="ILUSI_7320.Report20BukuSeringDipinjam" %>
...
<body style="background-image:url('Kapus.jpg'); width:auto">
    <form id="form1" runat="server">
        <center>
            ...
            <asp:Label runat="server" Text="Laporan 20 Buku Paling Sering Dipinjam" ForeColor="White"></asp:Label>
        </center>
        <br />
        <div>    
            <center>
